...
export const Predict = () => {
  ...
  return (
    <section className="flex md:flex-row flex-col">
      ...
      <div className="flex md:flex-col flex-row lg:w-full justify-between md:w-[40%] w-full md:mt-0 mt-6 lg:ml-[10%] md:ml-[5%] ml-0 md:gap-0 gap-3">
        <ImagePath
          ...
          loading="lazy"
        />
        <p className="lg:text-body text-[15px] text-white md:self-end self-start lg:w-[472px] lg:mt-0 md:mt-2 mt-0 w-full">
          {t('text')}
        </p>
      </div>
    </section>
